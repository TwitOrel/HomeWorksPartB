...
public class DLinkedList<T> implements List<T> {
    ...
    // Remove and return the element at the cursor position.
    @Override
    public T remove() {
        if (isEmpty()) {
            return null;
    ...
    // Remove and return the first occurrence of the given element.
    @Override
    ...
    // Clear the list by resetting head, tail, and cursor.
    @Override
    public void clear() {
        this.head = this.tail = this.cursor = null;
    }

    // Replace the element at the cursor position with a new element.
    @Override
    ...
    // Get the element after the cursor and move the cursor forward.
    @Override
    public T getNext() {
        if (!hasNext()){
            return null;
    ...
    // Get the element before the cursor and move the cursor backward.
    @Override
    public T getPrev() {
        if (!hasPrev()) {
            return null;
